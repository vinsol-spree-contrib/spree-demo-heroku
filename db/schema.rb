...
ActiveRecord::Schema.define(version: 20180418143322) do
  ...
  add_index "spree_assets", ["digital_asset_id"], name: "index_spree_assets_on_digital_asset_id", using: :btree
  ...
  add_index "spree_folders", ["lft"], name: "index_spree_folders_on_lft", using: :btree
  add_index "spree_folders", ["parent_id"], name: "index_spree_folders_on_parent_id", using: :btree
  add_index "spree_folders", ["rgt"], name: "index_spree_folders_on_rgt", using: :btree
